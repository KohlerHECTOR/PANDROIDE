...
class bernoulliCEM(GenericNet):
    ...
    def set_weights(self, weights):
        ...
        fc2_end = (h1_size*h2_size)+h2_size
        fc2_W = torch.from_numpy(weights[:h1_size*h2_size].reshape(h1_size, h2_size))
        fc2_b = torch.from_numpy(weights[h1_size*h2_size:fc2_end])
        ...
        self.fc3.weight.data.copy_(fc2_W.view_as(self.fc2.weight.data))
        self.fc3.bias.data.copy_(fc2_b.view_as(self.fc2.bias.data))
