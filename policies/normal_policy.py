...
#         fc1_w = self.fc1.weight.data.numpy().flatten()
#         fc1_b = self.fc1.bias.data.numpy().flatten()
#         fc2_w = self.fc2.weight.data.numpy().flatten()
#         fc2_b = self.fc2.bias.data.numpy().flatten()
#         fc_mu_w = self.fc_mu.weight.data.numpy().flatten()
#         fc_mu_b = self.fc_mu.bias.data.numpy().flatten()
#         return np.concatenate((fc1_w,fc1_b,fc2_w,fc2_b,fc_mu_w,fc_mu_b))
